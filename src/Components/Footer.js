                ...
                <div className="row justify-content-md-center">
                    ...
                    <div className="col col-lg-2 col-xs-12">
                        <div className="social-links text-center mb-3">
                            ...
                            <a className="secondary-button mr-2" target="blank" href="https://www.facebook.com/sharer/sharer.php?u=dramatime.mobi"><i className="lni-facebook-filled"></i></a>
                            <a className="secondary-button mr-2" target="blank" href="https://twitter.com/intent/tweet?text=dramatime.mobi"><i className="lni-twitter-filled"></i></a>
                            <a className="secondary-button" target="blank" href="whatsapp://send?text=dramatime.mobi" data-action="share/whatsapp/share"><i className="lni-whatsapp"></i></a>
                    </div>
